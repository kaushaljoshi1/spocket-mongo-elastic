...
class Product
  ...
  def self.filter search
    search_hash = search.slice(:category_name, :title, :supplier_name, :premium, :shipping_exclusions, :minprice, :maxprice).delete_if { |key, value| value.blank? }
    ...
    products.page(search[:page]).records.to_a
